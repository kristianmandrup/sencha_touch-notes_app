Ext.define  'FriendlyRent.view.search.Content'
  ...
  requires: [
    ...
    'FriendlyRent.view.search.criteria.Furnishment'
    'FriendlyRent.view.search.criteria.Size'
    'FriendlyRent.view.search.criteria.RentalCost'
    'FriendlyRent.view.search.criteria.RentalPeriod'
    'FriendlyRent.view.search.criteria.StartDate'
  ]
  config:
    items: [
      {
